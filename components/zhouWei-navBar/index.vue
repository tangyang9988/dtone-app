<template>
	<view>
		...
		>
			<view class="header_content">
				<view class="header_left_box">
					<slot name="left">
						<view :class="{ header_btnMongol: isTwoBtn, header_colorWhite_btnMongol: isWhite && isTwoBtn }" class="header_left_info" v-if="back || $slots.left || home">
							<view :class="{ header_btnMongol_left_back: isTwoBtn }" @click="onBackPage" class="header_left_back" v-if="back && !firstPage">
								<image class="header_icon" mode="aspectFit" src="/static/zhouWei-navBar/icon_back_white.png" v-if="isWhite"></image>
								<image class="header_icon" mode="aspectFit" src="/static/zhouWei-navBar/icon_back_black.png" v-else></image>
							</view>
							<text :class="{ header_colorWhite_left_line: isWhite }" class="header_left_line" v-if="isTwoBtn"></text>
							<view :class="{ header_btnMongol_left_home: isTwoBtn }" @click="onBackHome" class="header_left_home" v-if="(firstPage && back) || home">
								<image class="header_icon" mode="aspectFit" src="/static/zhouWei-navBar/icon_home_white.png" v-if="isWhite"></image>
								<image class="header_icon" mode="aspectFit" src="/static/zhouWei-navBar/icon_home_black.png" v-else></image>
							</view>
						</view>
					</slot>
					<view :style="{ color: navFontColor }" class="header_title" v-if="!titleCenter && ($slots.default || navTitle)">
						<slot>
							<text :style="{ color: navFontColor }">{{ navTitle }}</text>
						</slot>
					</view>
				</view>
				<view :style="{ color: navFontColor }" class="header_title header_title_center" v-if="titleCenter && ($slots.default || navTitle)">
					<slot>
						<text :style="{ color: navFontColor }">{{ navTitle }}</text>
					</slot>
				</view>
		...
		>
			<view class="header_content">
				<view class="header_left_box">
					...
					<view :style="{ color: navTransparentFixedFontColor }" class="header_title" v-if="!titleCenter && (navTitle || $slots.transparentFixed)">
						<slot name="transparentFixed">
							<text :style="{ color: navTransparentFixedFontColor }">{{ navTitle }}</text>
						</slot>
					</view>
				</view>
				<view :style="{ color: navTransparentFixedFontColor }" class="header_title header_title_center" v-if="titleCenter && (navTitle || $slots.transparentFixed)">
					<slot name="transparentFixed">
						<text :style="{ color: navTransparentFixedFontColor }">{{ navTitle }}</text>
					</slot>
				</view>
		...
		<view :style="{ paddingTop: statusBarHeight + 'px' }" v-if="type == 'fixed'"><view class="header_station"></view></view>
	</view>
</template>
<script>
// 主页页面的页面路径
