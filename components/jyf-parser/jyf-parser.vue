<template>
	<view>
		...
		<!--#ifdef APP-PLUS-NVUE-->
		<web-view :style="'margin-top:-2px;height:'+height+'px'" @onPostMessage="_message" id="_top" ref="web" />
		<!--#endif-->
		<!--#ifndef APP-PLUS-NVUE-->
		<view :style="showAm+(selectable?';user-select:text;-webkit-user-select:text':'')" id="_top" style="margin:20rpx">
			<!--#ifdef H5 || MP-360-->
			<div :id="'rtf'+uid"></div>
			<!--#endif-->
			<!--#ifndef H5 || MP-360-->
